...
const InfoBox = ({ img, title, desc}) => {
  return (
    <>
      <div className="p-[15px] md:p-[20px] bg-[#4D6580] rounded-[20px]">
        ...
        <div className="text-[12px] sm:text-[18px] md:text-[20px] font-[400] mt-[5px] sm:mt-[15px] whitespace-pre-line">{desc}</div>
      </div>
    </>
  )
}
