...
const TeamInfoType2 = (props) => {
  ...
  const css = check ? "text-[11px] sm:text-[19px] xl:text-[20px] font-[700] font-actay absolute bottom-[14px]" : "text-[11px] sm:text-[19px] xl:text-[20px] font-[700] font-actay mt-[88px]";
